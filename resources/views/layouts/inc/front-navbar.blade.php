<nav class="py-2 fixed-top bg-light">
  <div class="container d-flex">
   ...
   <a href="#"><img src="{{ asset('img/digikala-logo.png') }}" style="width:130px; height:40px"></a> 
  </div><!--end-div-container-->
  <div class="row">
    <div class="col-md-2 ">
      <button type="button" class="btn btn-outline-secondary bg-white btn-sm" data-toggle="modal" data-target="#myModal"><i class="fas fa-map-marker-alt"></i> لطفا شهر و استان خود را انتخاب کنید</button>
    </div>
<!-- Modal -->
        ...
        <li class="dropdown"><a a class="dropdown-toggle" data-toggle="dropdown" href="#"> <i class="fa fa-crosshairs"></i> دیجی پلاس</a>
          <ul class="dropdown-menu">
            <div class="card mb-3" style="width:600px;">
              <div class="row g-0">
                <div class="col-md-4">
                  <img src="{{ asset('img/plus.jpg') }}" style="width:250px; height:250px;">
                </div>
                <div class="col-md-8">
                  <div class="card-body">
