...
<section class="bg-danger">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <div class="carousel-col">
                  <div><img src="{{ asset('img/2-1.png') }}"></div>
                </div>
              </div>
              <div class="item">
                <div class="carousel-col">
                  <div><img src="{{ asset('img/2-2.png') }}"></div>
                </div>
              </div>
              <div class="item">
                <div class="carousel-col">
                  <div><img src="{{ asset('img/2-3.png') }}"></div>
                </div>
              </div>
              <div class="item">
                <div class="carousel-col">
                  <div><img src="{{ asset('img/2-4.png') }}"></div>
                </div>
              </div>
              <div class="item">
                <div class="carousel-col">
                  <div><img src="{{ asset('img/2-5.png') }}"></div>
                </div>
              </div>
            </div>
  ...
  <section class="bg-success">
    <div class="container my-4">
      <div class="row"><h1>شگفت انگیز سوپرمارکتی</h1>
        <img src="">
        <div class="col-centered">
          <div id="carousel" class="carousel slide" data-ride="carousel" data-type="multi" data-interval="2500">
            <div class="carousel-inner">
              <div class="item active">
                <div class="carousel-col">
                  <div><img src="{{ asset('img/4-1.png') }}"></div>
                </div>
              </div>
              <div class="item">
                <div class="carousel-col">
                  <div><img src="{{ asset('img/4-2.png') }}"></div>
                </div>
              </div>
              <div class="item">
                <div class="carousel-col">
                  <div><img src="{{ asset('img/4-3.png') }}"></div>
                </div>
              </div>
              <div class="item">
                <div class="carousel-col">
                  <div><img src="{{ asset('img/4-4.png') }}"></div>
                </div>
              </div>
              <div class="item">
                <div class="carousel-col">
                  <div><img src="{{ asset('img/4-5.png') }}"></div>
                </div>
              </div>
            </div>
