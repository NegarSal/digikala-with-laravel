...
<div class="swiper-container s1 swiper1">
    ...
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
         <a class="card" href="">
            <div class="image">
                <img src="{{ asset('img/kch.1.jpg') }}" alt="">
            </div>
            <div class="title">
                محصول شماره ۴
            </div>
